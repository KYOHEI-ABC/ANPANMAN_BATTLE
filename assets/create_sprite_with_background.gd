...
func create_sprite_with_background(input_path: String, output_size: Vector2i, bg_color: Color) -> void:
	...
	input.resize(output_size.x * 0.9, output_size.y * 0.9, Image.INTERPOLATE_LANCZOS)

	var output: Image = Image.create(output_size.x, output_size.y, false, Image.FORMAT_RGBA8)
	output.fill(bg_color)

	var border_thickness = output_size.x / 30
...
func _init():
	create_sprite_with_background("res://assets/a.png", Vector2i(128, 128), get_average_color("res://assets/a.png"))
	create_sprite_with_background("res://assets/b.png", Vector2i(128, 128), get_average_color("res://assets/b.png"))
	quit()
